...
public class VoipClientM implements ActionListener{
	...
	private MulticastSocket receive_socket; //the socket to receive on
	...
	private void clientConnect(String ip)	{
		...
		try {
			receive_socket = new MulticastSocket(receive_port);
			receive_socket.joinGroup(client_ip);
